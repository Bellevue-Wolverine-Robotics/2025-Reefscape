...
public class VisionSubsystem extends SubsystemBase {
  ...
  public VisionSubsystem() {
    ...
    backCamera = new PhotonCamera(VisionConstants.kBackCamera);
  ...
  public void setupSimulation() {
    ...
    // Create the PhotonCamera used in real robot code.
    frontCamera = new PhotonCamera("front");
    // Create the simulation instance for the PhotonCamera.
    frontCameraSim = new PhotonCameraSim(frontCamera, cameraProperties);
    // Optionally enable a wireframe visualization of the field.
    frontCameraSim.enableDrawWireframe(true);

    Transform3d robotToCameraTransform =
      VisionConstants.FRONT_CAMERA_TO_ROBOT.inverse();

    visionSystemSim.addCamera(frontCameraSim, robotToCameraTransform);
  }
