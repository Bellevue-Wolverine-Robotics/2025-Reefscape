...
public class RobotContainer {
  ...
  private void setDefaultOperatorBinds() {
    ...
    operatorController
      .a()
      .onTrue(
        elevatorSubsystem.setScoringPosition(ElevatorConstants.LEVEL_ZERO)
      );
    operatorController
      .leftBumper()
      .onTrue(
    ...
    operatorController
      .axisMagnitudeGreaterThan(1, OperatorConstants.kDeadzone)
      .whileTrue(
        elevatorSubsystem.moveManual(() -> operatorController.getLeftY())
      );
